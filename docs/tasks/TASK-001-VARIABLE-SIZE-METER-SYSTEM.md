...
**Enables**: TASK-003, TASK-004B, TASK-002B (schema validation and compilation)
...
### 6. Synergy with Coordinate Encoding (TASK-002A)
...
4. TASK-002B - Action space
5. TASK-004B - Universe compilation
6. TASK-004A - BRAIN_AS_CODE
