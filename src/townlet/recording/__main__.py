...
def main():
    parser = argparse.ArgumentParser(description="Export episode recordings to MP4 video")
    subparsers = parser.add_subparsers(dest="command", help="Command to run")

    # Single episode export
    export_parser = subparsers.add_parser("export", help="Export single episode to MP4")
    export_parser.add_argument("episode_id", type=int, help="Episode ID to export")
    export_parser.add_argument("--database", required=True, type=Path, help="Path to demo database")
    ...
    export_parser.add_argument("--output", required=True, type=Path, help="Output MP4 file path")
    export_parser.add_argument("--fps", type=int, default=30, help="Frames per second (default: 30)")
    export_parser.add_argument(
        "--speed",
        type=float,
        default=1.0,
    ...
    batch_parser.add_argument("--database", required=True, type=Path, help="Path to demo database")
    ...
    batch_parser.add_argument("--output-dir", required=True, type=Path, help="Output directory for MP4 files")
    batch_parser.add_argument("--stage", type=int, help="Filter by curriculum stage")
    batch_parser.add_argument("--reason", type=str, help="Filter by recording reason")
    batch_parser.add_argument("--min-reward", type=float, help="Minimum reward threshold")
    batch_parser.add_argument("--max-reward", type=float, help="Maximum reward threshold")
    batch_parser.add_argument("--limit", type=int, default=100, help="Maximum number of videos (default: 100)")
    batch_parser.add_argument("--fps", type=int, default=30, help="Frames per second (default: 30)")
    batch_parser.add_argument(
        "--speed",
        type=float,
        default=1.0,
